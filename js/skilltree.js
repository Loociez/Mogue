...
export const skillTree = {
  ...
  nodes: {
    ...
    "defense_3": [
      { id: "defense_4", name: "Energy Shield", desc: "Absorbs 50 damage per 30s", requires: "defense_3", branch: "middle", level: 0, maxLevel: 3, apply: (player, lvl) => { if(lvl>0) { player.energyShield = 50; player.energyShieldCooldown = 30; } } }
    ],
    "defense_4": [
      { id: "defense_5", name: "Stoneform", desc: "Temporary damage immunity", requires: "defense_4", branch: "middle", level: 0, maxLevel: 3, apply: (player, lvl) => { if(lvl>0) player.stoneform = true; } }
    ],
    ...
    "speed_2": [
      { id: "speed_3", name: "Blink", desc: "Dash forward", requires: "speed_2", branch: "right", level: 0, maxLevel: 1, apply: (player, lvl) => { if(lvl>0) { player.blinkDistance = 5; player.blinkCooldown = 10; } } }
    ],
    "speed_3": [
      { id: "speed_4", name: "Phase Strike", desc: "Attacks ignore 25% armor", requires: "speed_3", branch: "right", level: 0, maxLevel: 1, apply: (player, lvl) => { if(lvl>0) player.phaseStrike = 0.25; } }
    ],
    "speed_4": [
